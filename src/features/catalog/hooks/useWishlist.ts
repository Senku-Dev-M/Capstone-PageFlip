...
import { addBookToWishlist, removeBookFromWishlist, subscribeToUserWishlist } from "@/features/catalog/api/wishlist";
...
import type { WishlistItem } from "@/features/catalog/stores/useWishlistStore";
